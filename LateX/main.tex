...
\begin{figure}[H]
  ...
  \begin{subfigure}[b]{0.40\textwidth}
    \centering
    \includegraphics[width=\linewidth]{Imagens/primeira.png}
    \caption{Harmonic signal acquired with the ALEX-i camera.}
  \end{subfigure}
  \vspace{0.5cm}
  \begin{subfigure}[b]{0.40\textwidth}
    \centering
    \includegraphics[width=\linewidth]{Imagens/fourier.png}
...
\begin{figure}[H]
  ...
  \begin{subfigure}[b]{0.40\textwidth}
    \centering
    \includegraphics[width=\linewidth]{Imagens/reta.jpg}
    \caption{Line extraction in Fourier space for peak analysis.}
  \end{subfigure}
  \vspace{0.5cm}
  \begin{subfigure}[b]{0.40\textwidth}
    \centering
    \includegraphics[width=\linewidth]{Imagens/peaks.png}
